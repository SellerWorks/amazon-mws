...
/**
 * UpdateInboundShipmentResponse tests
 */
class UpdateInboundShipmentResponseTest extends TestCase
{
    /**
     * Test getResult
     */
    ...
    {
        $obj = new Responses\UpdateInboundShipmentResponse;
        $obj->ResponseMetadata = new ResponseMetadata;
        $obj->ResponseMetadata->RequestId = '982a45cf-af8c-42a7-bfeb-589317e86bc1';

        $obj->UpdateInboundShipmentResult = new Results\UpdateInboundShipmentResult;

        $this->assertTrue($obj->getResult() instanceof ResultInterface);
        $this->assertSame($obj->getResult(), $obj->UpdateInboundShipmentResult);
    }
}