...
/**
 * ListInboundShipmentsByNextTokenResult tests
 */
class ListInboundShipmentsByNextTokenResultTest extends TestCase
{
    /**
     * Test creation.
     */
    public function test_create()
    {
        ...
        $obj = new Results\ListInboundShipmentsByNextTokenResult;
